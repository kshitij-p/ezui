    ...
    return (
      <DialogPortal>
        ...
        <RadixDialog.Content
          {...rest}
          className={cn(
            "fixed z-dialog flex w-full max-w-[90vw] origin-top-left flex-col gap-4 overflow-y-auto rounded border bg-paper p-6 shadow shadow-black/20 focus:outline-none sm:max-w-lg",
